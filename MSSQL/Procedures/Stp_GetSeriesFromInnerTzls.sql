...
/****** Object:  StoredProcedure [dbo].[Stp_GetSeriesFromInnerTzls]    Script Date: 21/04/2026 11:08:12 ******/
SET ANSI_NULLS ON
GO
...
--baseis er param
if (@basis > 3000) --20200203 febmar måneder4 IKKE PENT, MEN SLIPPER ET ELLER FLERE EXTRA BASIS ARG..
begin
...
--TIMEPROBL
+ quotename(', "t":"',char(39) )
+ ' + Value +' --må ha fnutter rundt text.. erik for api
